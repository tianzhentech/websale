...
const COPY = {
  zh: {
    ...
    title: "账号格式转换工具",
    description:
      "把任意文本、JSON、CSV、表格残片或备注记录交给 LLM 整理，统一输出成 Gmail---Password---2fa密钥。",
    input: "原始输入",
    output: "标准输出",
    inputPlaceholder:
      "把任意账号内容贴到这里。\n\n支持混合格式，例如：\n- JSON / CSV / 文本段落\n- otpauth:// URL\n- 带中文说明的账号备注\n- 多账号批量列表",
    outputPlaceholder: "转换完成后，这里会输出每行 1 条的 Gmail---Password---2fa密钥。",
    convert: "开始转换",
    converting: "转换中...",
    clear: "清空",
    copy: "复制结果",
    ...
    noMatch: "暂未识别到可转换的 Gmail 账号。",
    convertedCount: "已整理 {count} 条账号",
    privacyHint:
      "内容会发送到当前配置的 LLM 服务进行整理，请不要粘贴不应该外发的敏感数据。",
    workingHint:
      "系统会尽量从杂乱格式中提取 Gmail、密码和 2FA 密钥，并统一整理成标准三段式。",
  ...
  en: {
    ...
    description:
      "Send arbitrary text, JSON, CSV, table fragments, or notes to the LLM and normalize them into Gmail---Password---2fa key lines.",
    input: "Raw Input",
    ...
    outputPlaceholder:
      "Converted lines will appear here as Gmail---Password---2fa key, one account per line.",
    convert: "Convert",
    ...
    noMatch: "No convertible Gmail accounts were recognized yet.",
    ...
    workingHint:
      "The system will try to extract Gmail, password, and 2FA secret from noisy input and reshape everything into the same 3-part format.",
    shortcutHint:
  ...
  vi: {
    ...
    description:
      "Gui van ban tuy y, JSON, CSV, du lieu bang hoac ghi chu vao LLM de chuan hoa thanh Gmail---Password---2fa key.",
    input: "Du Lieu Goc",
    ...
    outputPlaceholder:
      "Ket qua se duoc xuat moi dong 1 tai khoan theo dinh dang Gmail---Password---2fa key.",
    convert: "Chuyen Doi",
    ...
    noMatch: "Chua nhan dien duoc tai khoan Gmail phu hop.",
    ...
    workingHint:
      "He thong se co gang tach Gmail, mat khau va khoa 2FA tu du lieu lon xon va dua ve mot dinh dang 3 phan thong nhat.",
    shortcutHint:
