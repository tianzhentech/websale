  ...
  const copy =
    language === "zh"
      ? {
          ...
          backendTitle: "后端地址",
          backendDescription: "这里设置 Next.js 管理端转发到哪一个 Pixel 后端。保存后，首页和管理端的服务端请求都会立即使用新地址，并自动带上管理员密码。",
          ...
          backendPasswordUsingDefault: "当前没有覆盖密码，系统会使用环境变量中的默认密码。",
          backendSave: "保存地址",
          backendReset: "恢复默认",
          modeKicker: "Modes",
          modeTitle: "业务模式开关",
      ...
      : {
          ...
          backendDescription: "Set which Pixel backend the Next.js admin and homepage server routes should talk to. Once saved, server-side requests switch immediately and continue sending the shared admin password automatically.",
          ...
          backendPasswordUsingDefault: "No override password is saved right now, so the env default password is active.",
